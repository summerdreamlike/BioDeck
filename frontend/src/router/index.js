...
const routes = [
  ...
  },
  {
    ...
    children:[
       ...
       { path: 'levelt/level5-19', name: 'Level5-19', component: () => import('../views/student/levelt/Level5-19.vue') },
       { path: 'levelt/level5-20', name: 'Level5-20', component: () => import('../views/student/levelt/Level5-20.vue') },
